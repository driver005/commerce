...
type InjectedDependencies = {
    ...
    fulfillmentRepository: ReturnType<typeof FulfillmentRepository>
    trackingLinkRepository: ReturnType<typeof TrackingLinkRepository>
...
class FulfillmentService extends TransactionBaseService {
    ...
    protected readonly fulfillmentRepository_: ReturnType<typeof FulfillmentRepository>
    protected readonly trackingLinkRepository_: ReturnType<typeof TrackingLinkRepository>
        ...
        return await this.atomicPhase_(async (manager) => {
            ...
            for (const fItem of fulfillment.items) {
                ...
                const fulfilledQuantity =
                    item.fulfilled_quantity - fItem.quantity
