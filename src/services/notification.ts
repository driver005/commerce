...
type InjectedDependencies = {
    ...
    logger: Logger
    notificationRepository: ReturnType<typeof NotificationRepository>
    notificationProviderRepository: ReturnType<typeof NotificationProviderRepository>
}
...
class NotificationService extends TransactionBaseService {
    ...
    protected readonly notificationRepository_: ReturnType<typeof NotificationRepository>
    // eslint-disable-next-line max-len
    protected readonly notificationProviderRepository_: ReturnType<typeof NotificationProviderRepository>
    ...
    async registerInstalledProviders(providerIds: string[]): Promise<void> {
        ...
        const model = manager.withRepository(
            notificationProviderRepository
        )
    ...
    async resend(
        ...
        return await this.atomicPhase_(async (transactionManager) => {
            ...
            const resendNoti: Record<string, unknown> = {
                ...notification,
                id: null,
            }
            const created = notiRepo.create({
