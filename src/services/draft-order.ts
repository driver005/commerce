...
type InjectedDependencies = {
    ...
    draftOrderRepository: ReturnType<typeof DraftOrderRepository>
...
class DraftOrderService extends TransactionBaseService {
    ...
    protected readonly draftOrderRepository_: ReturnType<typeof DraftOrderRepository>
                ...
                qb.andWhere(
                    new Brackets((qb) => {
                        qb.where(`cart.email ILIKE :q`, {
                            ...
                            `draft_order.display_id::TEXT ILIKE :displayId`,
                            {
                                displayId: `${q}`,
                            }
                        )
