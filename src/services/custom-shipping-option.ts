...
type InjectedDependencies = {
    ...
    customShippingOptionRepository: ReturnType<typeof CustomShippingOptionRepository>
}
class CustomShippingOptionService extends TransactionBaseService {
    protected manager_: EntityManager
    protected transactionManager_: EntityManager | undefined
    // eslint-disable-next-line max-len
    protected customShippingOptionRepository_: ReturnType<typeof CustomShippingOptionRepository>
    ...
    async retrieve(
        ...
        const customShippingOption = await customShippingOptionRepo.findOne(
            query
        )
