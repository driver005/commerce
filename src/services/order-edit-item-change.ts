...
type InjectedDependencies = {
    ...
    orderItemChangeRepository: ReturnType<typeof OrderItemChangeRepository>
...
export default class OrderEditItemChangeService extends TransactionBaseService {
    ...
    protected readonly orderItemChangeRepository_: ReturnType<typeof OrderItemChangeRepository>
    ...
    async delete(itemChangeIds: string | string[]): Promise<void> {
        ...
        return await this.atomicPhase_(async (manager) => {
            ...
            await orderItemChangeRepo.delete({
                id: In(itemChangeIds as string[]),
            })
            ...
            await this.eventBus_
                .withTransaction(manager)
                .emit(OrderEditItemChangeService.Events.DELETED, {
                    ids: itemChangeIds,
                })
        })
    }
