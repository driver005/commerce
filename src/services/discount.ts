...
type DiscountServiceProps = {
    manager: EntityManager
    transactionManager: EntityManager | undefined
    discountRepository: ReturnType<typeof DiscountRepository>
    customerService: CustomerService
    discountRuleRepository: ReturnType<typeof DiscountRuleRepository>
    giftCardRepository: ReturnType<typeof GiftCardRepository>
    discountConditionRepository: ReturnType<typeof DiscountConditionRepository>
...
class DiscountService extends TransactionBaseService {
    ...
    protected readonly discountRepository_: ReturnType<typeof DiscountRepository>
    protected readonly customerService_: CustomerService
    protected readonly discountRuleRepository_: ReturnType<typeof DiscountRuleRepository>
    protected readonly giftCardRepository_: ReturnType<typeof GiftCardRepository>
    // eslint-disable-next-line max-len
    protected readonly discountConditionRepository_: ReturnType<typeof DiscountConditionRepository>
    ...
    async list(
        ...
        const discountRepo = manager.withRepository(
    ...
    async listAndCount(
        ...
        const query = buildQuery(selector as Selector<Discount>, config) as any
    ...
    async create(discount: CreateDiscountInput): Promise<Discount> {
        return await this.atomicPhase_(async (manager: EntityManager) => {
            ...
            const ruleRepo = manager.withRepository(
    ...
    async retrieveByCode(
        ...
        let query = buildQuery(
            { code: normalizedCode, is_dynamic: false },
            config
        )
        ...
        if (!discount) {
            query = buildQuery(
                { code: normalizedCode, is_dynamic: true },
                config
            )
    ...
    async update(
        ...
        return await this.atomicPhase_(async (manager) => {
            ...
            if (rule) {
                const ruleUpdate: Omit<UpdateDiscountRuleInput, 'conditions'> =
                    rule
        ...
        return await this.atomicPhase_(async (manager) => {
            ...
            if (discount.valid_duration) {
                ...
                lastValidDate.setSeconds(
                    lastValidDate.getSeconds() +
                        toSeconds(parse(discount.valid_duration))
                )
    ...
    async validateDiscountForProduct(
        ...
        return await this.atomicPhase_(async (manager) => {
            const discountConditionRepo = manager.withRepository(this.discountConditionRepository_)
    ...
    async isValidForRegion(
        ...
        return await this.atomicPhase_(async () => {
            ...
            if (discount.parent_discount_id) {
                const parent = await this.retrieve(
