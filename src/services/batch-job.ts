...
type InjectedDependencies = {
    ...
    batchJobRepository: ReturnType<typeof BatchJobRepository>
...
class BatchJobService extends TransactionBaseService {
    ...
    protected readonly batchJobRepository_: ReturnType<typeof BatchJobRepository>
    ...
    async retrieve(
        ...
        const batchJobRepo = manager.withRepository(
