...
type InjectedDependencies = {
    ...
    productCollectionRepository: ReturnType<typeof ProductCollectionRepository>
}
...
class ProductCollectionService extends TransactionBaseService {
    ...
    protected readonly productCollectionRepository_: ReturnType<typeof ProductCollectionRepository>
    ...
    async listAndCount(
        ...
        if (query.where.discount_condition_id) {
            const discountConditionId = query.where
