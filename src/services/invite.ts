...
type InviteServiceProps = {
    ...
    inviteRepository: ReturnType<typeof InviteRepository>
...
class InviteService extends TransactionBaseService {
    ...
    protected readonly userRepo_: ReturnType<typeof UserRepository>
    protected readonly inviteRepository_: ReturnType<typeof InviteRepository>
    ...
    async list(selector, config = {}): Promise<ListInvite[]> {
        const inviteRepo = this.manager_.withRepository(InviteRepository(this.manager_))
    ...
    async create(
        ...
        return await this.atomicPhase_(async (manager) => {
            const inviteRepository =
                this.manager_.withRepository(InviteRepository(this.manager_))

            const userRepo = this.manager_.withRepository(UserRepository(this.manager_))
    ...
    async delete(inviteId): Promise<void> {
        return await this.atomicPhase_(async (manager) => {
            const inviteRepo = manager.withRepository(InviteRepository(this.manager_))
    ...
    async accept(token, user_): Promise<User> {
        ...
        return await this.atomicPhase_(async (m) => {
            ...
            const inviteRepo: ReturnType<typeof InviteRepository> = m.withRepository(
