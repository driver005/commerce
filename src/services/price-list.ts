...
type PriceListConstructorProps = {
    ...
    priceListRepository: ReturnType<typeof PriceListRepository>
...
class PriceListService extends TransactionBaseService {
    ...
    protected readonly priceListRepo_: ReturnType<typeof PriceListRepository>
    protected readonly moneyAmountRepo_: ReturnType<typeof MoneyAmountRepository>
    protected readonly productVariantRepo_: ReturnType<typeof ProductVariantRepository>
    ...
    async retrieve(
        ...
        const priceListRepo = this.manager_.withRepository(
            this.priceListRepo_
        )
    ...
    async create(
        ...
        return await this.atomicPhase_(async (manager: EntityManager) => {
            const priceListRepo = manager.withRepository(
                this.priceListRepo_
            )
            ...
            const { prices, customer_groups, includes_tax, ...rest } =
                priceListObject
