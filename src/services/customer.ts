...
type InjectedDependencies = {
    ...
    customerRepository: ReturnType<typeof CustomerRepository>
...
class CustomerService extends TransactionBaseService {
    protected readonly customerRepository_: ReturnType<typeof CustomerRepository>
    ...
    async list(
        ...
        const customerRepo = manager.withRepository(
    ...
    async updateBillingAddress_(
        ...
        return await this.atomicPhase_(async (manager) => {
            const addrRepo = manager.withRepository(
