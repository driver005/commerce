...
type InjectedDependencies = {
    ...
    paymentRepository: ReturnType<typeof PaymentRepository>
    refundRepository: ReturnType<typeof RefundRepository>
...
export default class PaymentProviderService extends TransactionBaseService {
    ...
    protected readonly paymentRepository_: ReturnType<typeof PaymentRepository>
    protected readonly refundRepository_: ReturnType<typeof RefundRepository>
    ...
    async listPayments(
        ...
        const payRepo = this.manager_.withRepository(
            this.paymentRepository_
        )
    ...
    async refundFromPayment(
        ...
        return await this.atomicPhase_(async (manager) => {
            ...
            const paymentRepo = manager.withRepository(
                this.paymentRepository_
            )
            await paymentRepo.save(payment)

            const refundRepo = manager.withRepository(
                this.refundRepository_
            )
    ...
    async retrieveRefund(
        ...
        const refRepo = this.manager_.withRepository(
            this.refundRepository_
        )
