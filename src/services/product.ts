...
type InjectedDependencies = {
    ...
    productOptionRepository: ReturnType<typeof ProductOptionRepository>
    productRepository: ReturnType<typeof ProductRepository>
    productVariantRepository: ReturnType<typeof ProductVariantRepository>
    productTypeRepository: ReturnType<typeof ProductTypeRepository>
    productTagRepository: ReturnType<typeof ProductTagRepository>
    imageRepository: ReturnType<typeof ImageRepository>
...
class ProductService extends TransactionBaseService {
    ...
    protected readonly productOptionRepository_: ReturnType<typeof ProductOptionRepository>
    protected readonly productRepository_: ReturnType<typeof ProductRepository>
    protected readonly productVariantRepository_: ReturnType<typeof ProductVariantRepository>
    protected readonly productTypeRepository_: ReturnType<typeof ProductTypeRepository>
    protected readonly productTagRepository_: ReturnType<typeof ProductTagRepository>
    protected readonly imageRepository_: ReturnType<typeof ImageRepository>
    ...
    async create(productObject: CreateProductInput): Promise<Product> {
        return await this.atomicPhase_(async (manager) => {
            ...
            const optionRepo = manager.withRepository(
            ...
            if (
                ...
                if (isDefined(salesChannels)) {
                    ...
                    if (salesChannels?.length) {
                        const salesChannelIds = salesChannels?.map(
                            (sc) => sc.id
                        )
    ...
    async updateOption(
        ...
        return await this.atomicPhase_(async (manager) => {
            ...
            const optionExists = product.options.some(
                (o) =>
                    o.title.toUpperCase() === title.toUpperCase() &&
                    o.id !== optionId
            )
            if (optionExists) {
                throw new MedusaError(
