...
type InjectedDependencies = {
    ...
    moneyAmountRepository: ReturnType<typeof MoneyAmountRepository>
    productOptionValueRepository: ReturnType<typeof ProductOptionValueRepository>
...
class ProductVariantService extends TransactionBaseService {
    ...
    protected readonly moneyAmountRepository_: ReturnType<typeof MoneyAmountRepository>
    protected readonly productOptionValueRepository_: ReturnType<typeof ProductOptionValueRepository>
        ...
        return await this.atomicPhase_(async (manager: EntityManager) => {
            ...
            if (typeof product === `string`) {
                product = (await productRepo.findOne({
                    where: { id: productOrProductId as any},
    ...
    async setCurrencyPrice(
        ...
        return await this.atomicPhase_(async (manager: EntityManager) => {
            ...
            return await moneyAmountRepo.upsertVariantCurrencyPrice(
                variantId,
                price
            )
        })
    ...
    async deleteOptionValue(
        ...
        return await this.atomicPhase_(async (manager: EntityManager) => {
            const productOptionValueRepo = manager.withRepository(this.productOptionValueRepository_)
    ...
    getFreeTextQueryBuilder_(
        variantRepo: ReturnType<typeof ProductVariantRepository>,
