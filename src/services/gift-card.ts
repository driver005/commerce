...
type InjectedDependencies = {
    ...
    giftCardTransactionRepository: ReturnType<typeof GiftCardTransactionRepository>
...
class GiftCardService extends TransactionBaseService {
    ...
    protected readonly giftCardTransactionRepo_: ReturnType<typeof GiftCardTransactionRepository>
    ...
    async listAndCount(
        ...
        const giftCardRepo = manager.withRepository(
    ...
    async createTransaction(
        ...
        const manager = this.manager_
        const gctRepo = manager.withRepository(
