...
class ProductTypeService extends TransactionBaseService {
    ...
    protected readonly typeRepository_: ReturnType<typeof ProductTypeRepository>

    constructor({ manager, productTypeRepository }: ProductTypeServiceProps) {
        super(arguments[0])
