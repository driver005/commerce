...
type InjectedDependencies = {
    ...
    publishableApiKeyRepository: ReturnType<typeof PublishableApiKeyRepository>
}
...
class PublishableApiKeyService extends TransactionBaseService {
    ...
    protected readonly publishableApiKeyRepository_: ReturnType<typeof PublishableApiKeyRepository>
    ...
    async delete(publishableApiKeyId: string): Promise<void> {
        return await this.atomicPhase_(async (manager) => {
            ...
            const publishableApiKey = await this.retrieve(
                publishableApiKeyId
            ).catch()
