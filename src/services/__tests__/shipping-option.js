...
describe('ShippingOptionService', () => {
    ...
    describe('update', () => {
        ...
        const fulfillmentProviderService = {
            canCalculate: jest
                .fn()
                .mockImplementation(
                    (option) => option.provider_id !== 'no_calc'
                ),
        }
        ...
        it('calls updateOne with correct params', async () => {
            await optionService.update(IdMap.getId('option'), {
                name: 'new title',
            })
        ...
        it('sets requirements', async () => {
            ...
            expect(
                shippingOptionRequirementRepository.save
        ...
        it('sets calculated price', async () => {
            ...
            expect(
                fulfillmentProviderService.canCalculate
            ).toHaveBeenCalledTimes(1)
            expect(
                fulfillmentProviderService.canCalculate
            ).toHaveBeenCalledWith({
    ...
    describe('addRequirement', () => {
        ...
        it('add product to profile successfully', async () => {
            ...
            expect(shippingOptionRequirementRepository.create).toBeCalledTimes(
                0
            )
    ...
    describe('removeRequirement', () => {
        ...
        it('remove requirement successfully', async () => {
            ...
            expect(shippingOptionRequirementRepository.findOne).toBeCalledTimes(
                1
            )
            ...
            expect(
                shippingOptionRequirementRepository.softRemove
            ).toBeCalledTimes(1)
        })
    ...
    describe('create', () => {
        ...
        const regionService = {
            ...
            retrieve: () => {
                return Promise.resolve({
                    fulfillment_providers: [{ id: 'provider' }],
                })
            },
        }
        ...
        it('creates a shipping option', async () => {
            ...
            expect(
                fulfillmentProviderService.validateOption
            ).toHaveBeenCalledTimes(1)
            expect(
                fulfillmentProviderService.validateOption
    ...
    describe('createShippingMethod', () => {
        ...
        it('validates', async () => {
            ...
            expect(
                providerService.validateFulfillmentData
            ).toHaveBeenCalledTimes(1)
            expect(
                providerService.validateFulfillmentData
            ).toHaveBeenCalledWith(
        ...
        it('fails if reqs are not satisfied', async () => {
            ...
            await expect(
                optionService.createShippingMethod(
                    IdMap.getId('validId'),
                    data,
                    {
                        cart,
