...
describe('OrderService', () => {
    ...
    describe('createFromCart', () => {
        ...
        it('calls order model functions', async () => {
            ...
            expect(paymentProviderService.updatePayment).toHaveBeenCalledTimes(
                1
            )
                ...
                switch (q.where.id) {
                    ...
                    default:
                        return Promise.resolve({
                            ...
                            status: 'pending',
                            fulfillments: [
                                { id: 'fulfillment_test', canceled_at: now },
                            ],
    ...
    describe('capturePayment', () => {
                ...
                switch (q.where.id) {
                    case IdMap.getId('fail'):
                        return Promise.resolve({
                            payment_status: 'awaiting',
                            payments: [
                                { id: 'payment_fail', captured_at: null },
                            ],
                        })
                    ...
                    default:
                        return Promise.resolve({
                            ...
                            payments: [
                                { id: 'payment_test', captured_at: null },
                            ],
                        })
                }
            },
        ...
        it('calls order model functions', async () => {
            ...
            expect(paymentProviderService.capturePayment).toHaveBeenCalledTimes(
                1
            )
    ...
    describe('createFulfillment', () => {
        ...
        it('calls order model functions', async () => {
            ...
            expect(fulfillmentService.createFulfillment).toHaveBeenCalledTimes(
                1
            )
    ...
    describe('registerReturnReceived', () => {
        ...
        it('calls order model functions', async () => {
            ...
            expect(paymentProviderService.refundPayment).toHaveBeenCalledTimes(
                1
            )
        ...
        const optionService = {
            createShippingMethod: jest
                ...
                .mockImplementation((optionId, data, config) =>
                    Promise.resolve({
                        shipping_option: { profile_id: optionId },
                    })
                ),
