    ...
    describe('update status', () => {
        ...
        describe('complete', () => {
            it('should be able to complete a batch job', async () => {
                ...
                const updatedBatchJob2 = await batchJobService.complete(
                    batchJob2
                )
            ...
            it('should not be able to complete a batch job with the wrong status', async () => {
                ...
                const err2 = await batchJobService
                    .complete(batchJob2)
                    .catch((e) => e)
        ...
        describe('pre processed', () => {
            it('should be able to mark as pre processed a batch job in dry_run', async () => {
                ...
                const updatedBatchJob =
                    await batchJobService.setPreProcessingDone(batchJob)
        ...
        describe('processing', () => {
            it('should be able to mark as processing a batch job', async () => {
                ...
                const updatedBatchJob = await batchJobService.setProcessing(
                    batchJob
                )
