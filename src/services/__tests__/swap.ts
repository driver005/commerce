...
describe('SwapService', () => {
    describe('createCart', () => {
        ...
        describe('success', () => {
            ...
            const customShippingOptionService = {
                create: jest
                    .fn()
                    .mockReturnValue(Promise.resolve({ id: 'cso-test' })),
                update: jest.fn().mockReturnValue(Promise.resolve()),
                withTransaction: function () {
                    return this
                },
            ...
            it('finds swap and calls return create cart', async () => {
                ...
                expect(lineItemService.createReturnLines).toHaveBeenCalledTimes(
                    1
                )
    ...
    describe('create', () => {
        ...
        describe('success', () => {
            ...
            const returnService = {
                create: jest
                    .fn()
                    .mockReturnValue(Promise.resolve({ id: 'ret' })),
                withTransaction: function () {
                    return this
                },
    ...
    describe('cancelFulfillment', () => {
        ...
        it('successfully cancels fulfillment and corrects swap status', async () => {
            ...
            expect(fulfillmentService.cancelFulfillment).toHaveBeenCalledTimes(
                1
            )
    ...
    describe('registerCartCompletion', () => {
        ...
        describe('failure', () => {
            ...
            it('throws an error because inventory is to low', async () => {
                try {
                    await swapService.registerCartCompletion(
                        IdMap.getId('swap')
                    )
                } catch (e) {
    ...
    describe('processDifference', () => {
        ...
        describe('success', () => {
            ...
            it('capture success', async () => {
                ...
                expect(
                    paymentProviderService.capturePayment
                ).toHaveBeenCalledWith({
                    id: 'good',
                })
            ...
            it('refund success', async () => {
                ...
                expect(
                    paymentProviderService.refundPayment
                ).toHaveBeenCalledWith(
                    [
                        {
                            id: 'good',
            ...
            it('fails as swap is canceled', async () => {
                await expect(
                    swapService.processDifference('canceled')
            ...
            it('not confirmed', async () => {
                await expect(
                    swapService.processDifference('not_conf')
                ).rejects.toThrow(
        ...
        describe('registerReceived', () => {
            ...
            it('fails to register as received when swap is canceled', async () => {
                await expect(
                    swapService.registerReceived('canceled')
                ).rejects.toThrow(
    ...
    describe('cancel', () => {
        ...
        it('successfully cancels valid swap', async () => {
            ...
            expect(paymentProviderService.cancelPayment).toHaveBeenCalledTimes(
                1
            )
        ...
        it.each([['fail-refund-1'], ['fail-refund-2'], ['fail-refund-3']])(
            ...
            async (input) => {
                await expect(
                    swapService.cancel(IdMap.getId(input))
