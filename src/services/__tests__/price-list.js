...
describe('PriceListService', () => {
    ...
    moneyAmountRepository.removePriceListPrices = jest.fn(() =>
        Promise.resolve()
    )
    moneyAmountRepository.updatePriceListPrices = jest.fn(() =>
        Promise.resolve()
    )
    ...
    describe('create', () => {
        it('creates a new Price List', async () => {
            ...
            expect(
                moneyAmountRepository.addPriceListPrices
    ...
    describe('update', () => {
        ...
        it('update only existing price lists and related money amount', async () => {
            ...
            expect(
                updateRelatedMoneyAmountRepository.create
