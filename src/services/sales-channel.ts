...
type InjectedDependencies = {
    salesChannelRepository: ReturnType<typeof SalesChannelRepository>
...
class SalesChannelService extends TransactionBaseService {
    ...
    protected readonly salesChannelRepository_: ReturnType<typeof SalesChannelRepository>
    ...
    async listAndCount(
        ...
        if (q) {
            return await salesChannelRepo.getFreeTextSearchResultsAndCount(
                q,
                query
            )
        }
    ...
    async create(data: CreateSalesChannelInput): Promise<SalesChannel | never> {
        return await this.atomicPhase_(async (manager) => {
            const salesChannelRepo = manager.withRepository(this.salesChannelRepository_)
