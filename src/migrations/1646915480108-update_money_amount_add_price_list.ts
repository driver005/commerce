...
export class updateMoneyAmountAddPriceList1646915480108
    implements MigrationInterface
{
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "price_list_customer_groups" ("price_list_id" character varying NOT NULL, "customer_group_id" character varying NOT NULL, CONSTRAINT "PK_1afcbe15cc8782dc80c05707df9" PRIMARY KEY ("price_list_id", "customer_group_id"))`
        )
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "money_amount" DROP COLUMN "sale_amount"`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" ADD "min_quantity" integer`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" ADD "max_quantity" integer`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" ADD "price_list_id" character varying`
        )
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "price_list_customer_groups" DROP CONSTRAINT "FK_c5516f550433c9b1c2630d787a7"`
        )
        await queryRunner.query(
            `ALTER TABLE "price_list_customer_groups" DROP CONSTRAINT "FK_52875734e9dd69064f0041f4d92"`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" DROP CONSTRAINT "FK_f249976b079375499662eb80c40"`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" DROP COLUMN "price_list_id"`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" DROP COLUMN "max_quantity"`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" DROP COLUMN "min_quantity"`
        )
        await queryRunner.query(
            `ALTER TABLE "money_amount" ADD "sale_amount" integer`
        )
