...
export default async (req, res) => {
    ...
    try {
                                ...
                                idempotencyKey = await idempotencyKeyService
                                    ...
                                    .workStage(
                                        ...
                                        async (manager) => {
                                            ...
                                            returnObj.no_notification =
                                                evaluatedNoNotification
                    ...
                    await manager.transaction(async (transactionManager) => {
                        idempotencyKey = await idempotencyKeyService
                            ...
                            .update(idempotencyKey.idempotency_key, {
                                ...
                                response_code: 500,
                                response_body: {
                                    message: 'Unknown recovery point',
                                },
                            })
                    })
                    break
        ...
        res.status(idempotencyKey.response_code).json(
...
export class AdminPostOrdersOrderReturnsReq {
    ...
    @ValidateNested()
    @Type(() => ReturnShipping)
    return_shipping?: Awaited<ReturnShipping>
