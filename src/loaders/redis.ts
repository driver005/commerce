...
async function redisLoader({
    ...
    if (configModule.projectConfig.redis_url) {
        ...
        const client = new RealRedis(configModule.projectConfig.redis_url, { maxRetriesPerRequest: null, enableReadyCheck: false })
        const subscriber = new RealRedis(configModule.projectConfig.redis_url, { maxRetriesPerRequest: null, enableReadyCheck: false })
