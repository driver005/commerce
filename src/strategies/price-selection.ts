...
type PriceSelectionStrategyProps = {
...
class PriceSelectionStrategy extends AbstractPriceSelectionStrategy {
    private moneyAmountRepository_: ReturnType<typeof MoneyAmountRepository>
    private featureFlagRouter_: FlagRouter
    private manager_: EntityManager

    constructor({ manager, featureFlagRouter, moneyAmountRepository }: PriceSelectionStrategyProps) {
        super()
    ...
    private async calculateVariantPrice_new(
        ...
        for (const ma of prices) {
            ...
            if (
                ...
                result.calculatedPriceType =
                    ma.price_list?.type || PriceType.DEFAULT
